    ...
    <>
      <footer className=" w-full">
        <div className="Footer ">
          <div className="foot h-[30vh] mt-5 p-4 bg-[#3A1F44] flex justify-evenly max-sm:justify-center max-sm:flex-col gap-2 items-center relative">
            <div className="absolute left-2">
              <img
                className="w-50 max-md:w-30 max-sm:w-20"
                src={namelogo}
                alt=""
              />
            </div>
